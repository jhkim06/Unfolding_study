...
void exercise3(void) {
  //==============================================================
  // Unfolding exercise 3
  //  unfold data, MC1,MC2
  //  using the correction factors obtained from MC1
  //  try this with and without background subtraction
  //==============================================================
  ...
  // results for BBB
  TH1D *hist_data_BBB=new TH1D("hist_data_BBB","data corrected with MC1 ;r_{BBB}",nBin,r0,r1);
  TH1D *hist_mc1_BBB=new TH1D("hist_mc1_BBB","MC1 corrected with MC1;r_{BBB}",nBin,r0,r1);
  TH1D *hist_mc2_BBB=new TH1D("hist_mc2_BBB","MC2 corrected with MC1;r_{BBB}",nBin,r0,r1);
  ...
  canvas->cd(2);
  hist_mc1_BBB->GetYaxis()->SetRangeUser(0.,ymax);
  ...
  canvas->cd(3);
  hist_mc2_BBB->GetYaxis()->SetRangeUser(0.,ymax);
