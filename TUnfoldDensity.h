...
class TUnfoldDensityV17 : public TUnfoldSysV17 {
 protected:
   const TUnfoldBinningV17 * fConstOutputBins; // binning scheme for the output
   const TUnfoldBinningV17 * fConstInputBins; // binning scheme for the input
   TUnfoldBinningV17 *fOwnedOutputBins; // output binning scheme if owner
   TUnfoldBinningV17 *fOwnedInputBins; // input binning scheme if owner
   TUnfoldBinningV17 *fRegularisationConditions; // binning scheme for the regularisation conditions
...
TUnfoldBinningV17 *GetLBinning(void) const { return fRegularisationConditions; } // binning scheme for regularisation conditions (matrix L)
   ClassDef(TUnfoldDensityV17, TUnfold_CLASS_VERSION) //Unfolding with densisty regularisation
};
